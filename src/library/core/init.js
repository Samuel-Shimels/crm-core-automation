...
var CrmLib = (function(ns) {
  ...
  /**
   * Initialize CRM sheets with standard headers if they do not exist.
   */
  self.initCrmSheets = function(spreadsheetId) {
    ...
    specs.forEach(spec => {
      ...
      // Ensure headers are set (first row)
